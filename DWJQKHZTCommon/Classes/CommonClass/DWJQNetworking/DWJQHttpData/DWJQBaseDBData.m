...
#import "DWJQBaseDBData.h"
#import "DWJQSqliteHelper.h"
...
static DWJQSqliteHelper *database = nil;
static NSMutableDictionary *tableCache = nil;
@interface DWJQBaseDBData(PrivateMethods)
-(void)insert;
-(void)updateAll;
@end

@interface DWJQBaseDBData()
    ...
    @synchronized(self){
        ...
        switch(type[0]) {
                ...
                //Handle different clases in here
            {
                ...
                if ([NSClassFromString(cls) isSubclassOfClass:[DWJQBaseDBData class]]) {
                    return DBObject;
                }
            }
                break;
